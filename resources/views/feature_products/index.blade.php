    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('feature_products.create') }}" class="btn btn-outline-primary btn-icon-text">
                    ...
                    <tbody>
                        @foreach ($featuredProducts as $featuredProduct)
                            <tr>
                                ...
                                <td>
                                    <!-- Edit Button -->
                                    <a href="{{ route('feature_products.edit', $featuredProduct->id) }}"
                                        class="btn btn-warning btn-sm">Edit</a>

                                    <!-- Delete Button -->
                                    <form action="{{ route('feature_products.destroy', $featuredProduct->id) }}"
